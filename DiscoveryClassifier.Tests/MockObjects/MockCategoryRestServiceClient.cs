...
namespace DiscoveryClassifier.Tests.MockObjects
{
    ...
    internal class MockCategoryRestServiceClient : IRestServiceClientCategories
    {

        public List<Category> GetCategories(string searchText)
        {
            var categories =  m_Categories.FindAll(c => c.Title.Contains(searchText));
            return categories;
        }
        ...
        private List<Category> m_Categories;
            ...
            public MockCategoryRestServiceClient()
            {
